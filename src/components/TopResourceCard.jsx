...
export default function TopResourceCard({ image, title, buttonText, children, link }) {
	return (
		<div className='top-resource-card'>
			...
			<div className="top-resource-cardBody">
				...
				<div className='top-resource-card-btn-cnt'>
					<a href={link} target="_blank" className="top-resource-card-btn "><span className='icon-arrow'>&#xe900;</span></a>
				</div>
			</div>
