			...
			<section className='color-light' >
				...
				<div className="container noPTop">
					...
					<div className="VCard-cnt col2">
						<VCard image="images/qii4/DiagnosingVulnerabilities/card1.png" title={<p><strong>Learning from Mega-disasters: </strong> Japan Case Study</p>} buttonText="Guidance" link="https://openknowledge.worldbank.org/entities/publication/db0df170-6101-526e-8fc8-d0e448196fc4" >
						...
						<VCard image="images/qii4/DiagnosingVulnerabilities/card2.png" title={<p><strong>World Bank Climate Knowledge Portal</strong></p>} buttonText="Tools" link="https://climateknowledgeportal.worldbank.org/ " >
						...
						<VCard image="images/qii4/DiagnosingVulnerabilities/card3.png" title={<p><strong>GFDRR ThinkHazard!</strong></p>} buttonText="Guidance" link="https://thinkhazard.org/en/  " >
						...
						<VCard image="images/qii4/DiagnosingVulnerabilities/card4.png" title={<p><strong>Geospatial Information Management and Analysis Project for Hazards and Risk Assessment in the Philippines</strong></p>} buttonText="Tools" link="https://georisk.gov.ph/  " >
					...
					<div className="VCard-cnt col3">
						...
						<VCard image="images/qii4/DiagnosingVulnerabilities/card5.png" title={<p><strong>Climate Impact Assessment Frameworks</strong> (Africa Infrastructure Example)</p>} buttonText="Guidance" link="https://openknowledge.worldbank.org/handle/10986/21875">
						...
						<VCard image="images/qii4/DiagnosingVulnerabilities/card6.png" title={<p><strong>Notre Dame Global Adaptation Initiative: </strong> ND-GAIN Vulnerability Indices</p>} buttonText="Tools" link="https://gain.nd.edu/our-work/country-index/rankings/ " >
						...
						<VCard image="images/qii4/DiagnosingVulnerabilities/card7.png" title={<p><strong>Vanuatu Post-Disaster Needs Assessment: </strong>Tropical Cyclone Pam</p>} buttonText="Case study" link="https://www.gfdrr.org/sites/default/files/publication/pda-2015-vanuatu.pdf" >
					...
					<div className="VCard-cnt col3">
						...
						<VCard image="images/qii4/DiagnosingVulnerabilities/card8.png" title={<p><strong>Disaster Risk Profiles </strong>(GFDRR)</p>} buttonText="Guidance" link="https://www.gfdrr.org/en/disaster-risk-profiles">
							<p>This resource details consistent, state-of-the-art methods to assess the vulnerability of Africa's power and water infrastructure, analyzing physical condition, design, and operational interdependencies to identify system weaknesses under climate stress and recommending ways to strengthen resilience and adaptive planning.</p>
						</VCard>

						<VCard image="images/qii4/DiagnosingVulnerabilities/card9.png" title={<p><strong>World Bank </strong> Resilience Rating System</p>} buttonText="Tools" link="https://blogs.worldbank.org/en/climatechange/building-resilience-in-investment-projects--the-power-of-resilie">
							<p>The ND-GAIN Country Index compares countries' vulnerabilities to climate change and other global challenges in combination with its readiness to improve resilience.</p>
						</VCard>

						<VCard image="images/qii4/DiagnosingVulnerabilities/card10.png" title={<p><strong>Global Infrastructure Risk Model and Resilience Index </strong> (GIRI) (Coalition for Disaster Resilient Infrastructure)</p>} buttonText="Case study" link="https://giri.unepgrid.ch/  ">
							<p>This Post-Disaster Needs Assessment (PDNA) looks at the scale of impact of Tropical Cyclone Pam on key sectors and the economy as a whole. This PDNA formed the basis of a Joint Action Plan prepared by the government of Vanuatu.</p>
						</VCard>

						<VCard image="images/qii4/DiagnosingVulnerabilities/card11.png" title={<p><strong>INFORM Climate Change Tool</strong>(European Commission)</p>} buttonText="Tools" link="https://drmkc.jrc.ec.europa.eu/inform-index/INFORM-Climate-Change/INFORM-Climate-Change-Tool">
						...
						<VCard image="images/qii4/DiagnosingVulnerabilities/card12.png" title={<p><strong>Jamaica Disaster Vulnerability Reduction Project</strong></p>} buttonText="Case study" link="https://www.worldbank.org/en/news/feature/2025/07/17/jamaica-how-investments-in-disaster-resilience-helped-protect-communities">
