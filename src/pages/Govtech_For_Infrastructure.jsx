  ...
  const step1Cards = [
    {
      ...
      title: (
        <p>
          Multi-country <br />
          <strong>
            Public Transport Demand Forecasting Regional Platform for the Post
            COVID-19 Era
          </strong>{" "}
          <br />
          World Bank
      ...
      content: (
        <p>
          With co-funding from the QII Partnership and the Mobility and
          Logistics Multidonor Trust Fund (MOLO), this project developed a
          replicable methodology for monitoring travel demand patterns using big
          data from mobile devices. The approach was demonstrated in Bogota,
          Buenos Aires, and Medellin, supporting transport authorities in
          leveraging new data sources to inform public transport planning and
  ...
  const step2Cards = [
    ...
    },
    {
      ...
      title: (
        <p>
          Global <br />
          <strong>GovTech Maturity Index Data Dashboard</strong> <br />
          World Bank
        </p>
      ),
      buttonText: "Data",
  ...
  const step3Cards = [
    {
      ...
      content: (
        <p>
          With support from the World Bank and the QII Partnership, Albania is
          advancing a GovTech paradigm that pairs public administration reform
          with digital technologies to transform service delivery. Today, 95% of
          central government services are available online through the e-Albania
          portal, serving over 3 million registered users, alongside 216
          Education Smart Labs and strengthened digital inclusion measures for
    ...
    },
    {
      ...
      title: (
        <p>
          ...
          <br />
          <strong>
            Supporting Sustainable Digital Infrastructure through Innovation
          </strong>{" "}
          <br />
          World Bank
        </p>
      ...
      content: (
        <p>
          This QII grant provides advisory and analytical support for ICT
          infrastructure management to underpin the Government of Kosovo's
          digital transformation of public services. The grant complements the
          World Bank's Strengthening Digital Governance for Service Delivery
          project, which targets improved system interoperability, an upgraded
          e-Kosova platform, and citizen-centric service delivery organized
          around life events.​
        </p>
      ),
    },
    ...
    <div className="Govtech_For_Infrastructure">
      <section className="color-light">
        ...
        <div className="container internal-pages-container">
          <NumSteps num="1" id="qii6-GI-section2">
          ...
          <VCardsPagination cardsData={step1Cards} id="qii6-GI-section3"/>
          <div className="border-dash"></div>
          <NumSteps num="2" id="qii6-GI-section4">
            <strong>
          ...
          <VCardsPagination cardsData={step2Cards} id="qii6-GI-section5"/>
          <div className="border-dash"></div>
          <NumSteps num="3" id="qii6-GI-section6">
            <strong>
          ...
          <VCardsPagination cardsData={step3Cards} id="qii6-GI-section7"/>
        </div>
      </section>
    </div>
  );
