  ...
  const step1Cards = [
    {
      ...
      content: (
        <p>
          There are numerous green and sustainable finance taxonomies in use or
          under development at national, regional, and international levels.
          This tool allows users to navigate through these taxonomies from a
          single source.
        </p>
      ),
    },
    {
      ...
      content: (
        <p>
          This taxonomy provides a common definition of economic activities that
          can be considered environmentally sustainable. It helps to scale up
          sustainable investment and protects investors from greenwashing.
        </p>
      ),
    },
    {
      ...
      content: (
        <p>
          This is a harmonized framework that aggregates various sustainable
          finance taxonomies to create a certification label specifically for
    ...
    },
    {
      ...
      content: (
        <p>
          The Climate Bonds Initiative develops sector-specific criteria that
          provide climate benchmarks across a range of infrastructure sectors to
          define projects eligible for climate finance.
        </p>
      ),
    },
  ];
  ...
  const step2Cards = [
    {
      ...
      content: (
        <p>
          ...
          Standard Carbon Credit Certification. This was achieved by modernizing
          waste treatment infrastructure – going from an open dump emitting 90
          million tons of CO₂ equivalent over the last 45 years – to a sanitary
          landfill with biogas collection and leachate treatment, which reduced
          210,000 tons of CO₂e per year.
        </p>
      ),
    },
    {
      ...
      title: (
        <p>
          South Africa <br />
          <strong>Cape Town Green Bond</strong>
          <br />
          World Bank
        </p>
      ),
      ...
      content: (
        <p>
          Illustrates how green bond certification builds investor confidence in
          climate-aligned municipal infrastructure. In 2017, amid severe
          drought, Cape Town issued a ZAR 1 billion (~US$75 million) Green Bond,
          the first in South Africa to receive CBI accreditation and the first
          to earn an “Excellent” rating from the rating agency Moody’s. Proceeds
          funded electric buses, energy-efficient buildings, water resilience
          initiatives, and coastal protection.
        </p>
      ),
    },
    {
      ...
      title: (
        <p>
          Brazil <br />
          <strong>Corsan Water Sustainability-Linked Loan</strong>
          <br />
      ...
      content: (
        <p>
          Demonstrates how sustainability-linked financing can drive efficiency
          improvements in state utilities. IFC provided a US$ 83 million loan to
          Corsan, the main water utility in Rio Grande do Sul state, to replace
          obsolete pumps and hydrometers. The loan was structured in a way that
          the interest rate would be reduced if Corsan met pre-agreed reductions
          in water losses.
        </p>
      ),
    },
    {
      ...
      content: (
        <p>
          These principles outline international best practices when issuing
          green bonds including the eligible use of proceeds, project evaluation
          and selection, management of proceeds, and reporting requirements.
        </p>
      ),
    },
    {
      ...
      content: (
        <p>
          Developed by the European Investment Bank, this tool helps project
          developers to assess the compliance of projects with the EIB's green
          eligibility criteria. While focused on Europe, the tool has also been
          expanded to be of relevance to countries across North Africa and the
          Middle East.
        </p>
      ),
    },
    ...
    <div className="procurement">
      <section className="color-light">
          ...
          <div className="hero-content">
            <div className="header-3-subpages">
              <img
                ...
                className="qii-badge"
              />
              <h1 className="header-title desk-title">Green Financing</h1>
            </div>
          </div>
        ...
        <div className="container internal-pages-container">
          <p className="link-text" id="qii3-GF-section2">
          ...
          <NumSteps num="1" id="qii3-GF-section3">
          ...
          <VCardsPagination cardsData={step1Cards} id="qii3-GF-section4"/>
          <div className="border-dash"></div>
          <NumSteps num="2" id="qii3-GF-section5">
          ...
          <VCardsPagination cardsData={step2Cards} id="qii3-GF-section6"/>
        </div>
      </section>
    </div>
  );
