			...
			<section className="landing_page" >
				...
				<div className="container" >
					<div className="content_left">
						<h1 ><strong>How Can We Help You Build Quality Infrastructure Today?</strong></h1>
						<p className='light-font '>Explore tools, principles, and resources to apply Quality Infrastructure Investment (QII) principles to your projects</p>
						<SearchBox></SearchBox>
					</div>
				</div>
			</section >
			<section className='color-dark  principles-page'>
				...
				<div className="container">
					...
					<div className="bottom-text-1">
						...
						<p><a href="#" target="_blank" className="">Click <span className="link">here</span></a></p>
					</div>
				</div>
			</section >
