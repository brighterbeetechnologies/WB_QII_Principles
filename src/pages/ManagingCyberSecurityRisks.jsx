            ...
            <section className='color-light' >
                ...
                <div className="container noPTop">
                    ...
                    <div className="VCard-cnt col3">
                        <VCard image="images/qii4/ManagingCyberSecurityRisks/card1.png" title={<p><strong>Cybersecurity Assessment Toolkit for Smart Cities</strong></p>} buttonText="Guidance" link="Cybersecurity Assessment Toolkit for Smart Cities" >
                        ...
                        <VCard image="images/qii4/ManagingCyberSecurityRisks/card2.png" title={<p><strong>UK: The Cyber Assessment Framework </strong>(CAF) (National Cyber Security Center, UK)</p>} buttonText="Guidance" link="https://www.ncsc.gov.uk/collection/cyber-assessment-framework/introduction-to-caf#section_1" >
                        ...
                        <VCard image="images/qii4/ManagingCyberSecurityRisks/card3.png" title={<p><strong>Sectoral Cybersecurity Maturity Model </strong>(World Bank)</p>} buttonText="Guidance" link="https://documents1.worldbank.org/curated/en/099062623085028392/pdf/P17263707c36b702309f7303dbb7266e1cf.pdf" >
                    ...
                    <div className="VCard-cnt col2">
                        <VCard image="images/qii4/ManagingCyberSecurityRisks/card4.png" title={<p><strong>Cybersecurity Economics for Emerging Markets </strong>(World Bank)</p>} buttonText="Report" link="https://documentsinternal.worldbank.org/Search/34392134" >
                        ...
                        <VCard image="images/qii4/ManagingCyberSecurityRisks/card5.png" title={<p><strong>Ghana: A case study in strengthening cyber resilience </strong>(World Bank)</p>} buttonText="Case study" link="https://documents1.worldbank.org/curated/en/099111623162584046/pdf/P17785201f69be0150909902c3a7202107e.pdf" >
                    ...
                    <div className="VCard-cnt col2">
                        <VCard image="images/qii4/ManagingCyberSecurityRisks/card4.png" title={<p><strong>Cybersecurity best practice for smart cities </strong>(CISA)</p>} buttonText="Guidance" link="https://www.cisa.gov/sites/default/files/2023-04/cybersecurity-best-practices-for-smart-cities_508.pdf" >
                        ...
                        <VCard image="images/qii4/ManagingCyberSecurityRisks/card5.png" title={<p><strong>Canada: the cyber threat environment</strong></p>} buttonText="Guidance" link="https://www.cyber.gc.ca/en/guidance/introduction-cyber-threat-environment" >
