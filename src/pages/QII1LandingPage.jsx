      ...
      <section className="q2_landing_page color-dark">
        ...
        <div className="container">
          <p className="header-text">
            ...
            eveniet amet soluta quasi rem autem cumque alias animi voluptatem
            dolores, facilis voluptatibus, quis facere enim sint. Repellat
            corrupti optio velit consequuntur saepe exercitationem, mollitia
            earum tenetur magnam non fuga doloribus omnis, quaerat quasi aperiam
            possimus alias odit, pariatur vero rem?
          </p>
