      ...
      <section className="color-light">
        ...
        <div className="container internal-pages-container">
          ...
          <div className="VCard-cnt col3">
            ...
            >
              <p>Hachioji City demonstrates how innovative use of 3D city models and augmented reality can significantly enhance local public engagement in urban planning, ultimately strengthening trust and collaboration between the city government and its citizens.</p>
            </VCard>
            <VCard
            ...
            >
              <p>This World Bank study on Tajikistan’s cross-border trade highlights the critical role of community engagement and inclusion, particularly of women traders, in official trade processes.</p>
            </VCard>
          </div>
        </div>
      </section>
